...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-black pb-[calc(env(safe-area-inset-bottom,0px)+4rem)] md:pb-[calc(env(safe-area-inset-bottom,0px)+2.5rem)] font-geist text-text-1">
      {/* Ambient orbs */}
      <div
